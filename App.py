...
if uploaded_file is not None:
    ...
    with st.spinner("⚡ DECRYPTING & PARSING SIGNAL MATRIX (RAM-OPTIMIZED)..."):
        try:
            ...
            # Use Librosa to directly read the file bytes.
            # 'duration=20.0' guarantees we never parse more than 20 seconds, protecting RAM limits!
            y, sr = librosa.load(io.BytesIO(file_bytes), sr=16000, duration=20.0)
